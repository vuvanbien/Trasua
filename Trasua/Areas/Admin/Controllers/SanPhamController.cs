...
namespace Trasua.Areas.Admin.Controllers
{
    ...
    public class SanPhamController : Controller
    {
        ...
        public SanPhamController(TrasuaContext context)
        {
            _context = context;
        }

        // GET: Admin/SanPham
        public async Task<IActionResult> Index(string searchTen, string lsp, decimal minban, decimal maxban, int page = 1, int pageSize = 5)
        {
        ...
        public async Task<IActionResult> Create(SanPham sp, IFormFile image1, string LoaiSp)
        {
