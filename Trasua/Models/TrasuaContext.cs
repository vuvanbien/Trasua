...
public partial class TrasuaContext : DbContext
{
    ...
    public TrasuaContext(DbContextOptions<TrasuaContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-HO14S58R;Initial Catalog=trasua;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Nguyenlieu>(entity =>
        {
            ...
            entity.Property(e => e.MaNl).ValueGeneratedNever();
            entity.Property(e => e.Dvt).HasMaxLength(500);
            entity.Property(e => e.TenNl).HasMaxLength(500);
        });
